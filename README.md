...
4. 右键点击 `小狼毫` 中英文切换图标，选择 `用户文件夹` 以打开用户文件夹；
5. 先 **清空** [^1] `用户文件夹` 内的全部文件，再将 `full` 文件夹中的所有文件复制进去；
6. 右键点击 `小狼毫` 中英文切换图标，选择 `重新部署`；
...
6. 右键点击“小狼毫”中英文切换图标，点击“用户文件夹”以打开用户文件夹；
7. 先清空“用户文件夹”内的全部文件，再将“full”文件夹中的所有文件复制进去；
8. 右键点击“小狼毫”中英文切换图标，点击“重新部署”；
